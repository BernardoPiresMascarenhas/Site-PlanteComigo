...
function PhaseCard({ phase }: { phase: typeof phases[0] }) {
  return (
    <motion.div
      ...
      className="group relative bg-ice p-10 cursor-pointer overflow-hidden"
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-[0.82rem] font-dm font-light text-warm-gray leading-[1.85] transition-colors duration-400 group-hover:text-sand/75">
          {phase.desc}
        </p>

        <span className="inline-block mt-6 text-[0.62rem] tracking-[0.2em] uppercase text-sage transition-all duration-400 group-hover:text-sand group-hover:translate-x-1">
          Saiba mais →
        </span>
      </div>
    </motion.div>
      ...
      <div className="max-w-[1300px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-end mb-20">
          <div>
            ...
            >
              As três fases de um projeto paisagístico
            </motion.p>
            <motion.h2
            ...
            >
              Criação,{" "}
              <em className="italic text-olive">implementação</em>
              <br />
              e manutenção.
            </motion.h2>
          </div>
        ...
        <motion.div
          ...
          className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-olive/15 mb-px"
        >
          {phases.map((phase) => (
