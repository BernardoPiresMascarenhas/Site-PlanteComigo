...
const detailedPhases = [
  {
    ...
    image: "/mangabeiras0.png", // Foto de planta/arquitetura
  },
  {
    id: "fornecedores",
    num: "02",
    ...
    image: "/bandeirantes0.png", // Foto de folhas/viveiro
  },
  {
    id: "implantacao",
    num: "03",
      ...
      <section className="py-32 px-8 md:px-12 bg-cream">
        <div className="max-w-[1300px] mx-auto space-y-32">
          {detailedPhases.map((phase, index) => {
            // Verifica se a linha é par ou ímpar para inverter o lado da imagem
            ...
            return (
              <div 
                key={phase.id} 
                id={phase.id} 
                className="scroll-mt-32" // Isso evita que o menu fixo cubra o título ao rolar a página
              >
